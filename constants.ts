...
export const DIMENSIONS: Dimension[] = [
  ...
  },
  {
    ...
    description: 'Liderler, yeni fikirlere açık olmaları ve zorlukları bir büyüme fırsatı olarak görmeleriyle büyüme zihniyetini sergilerler. Sistemi bir bütün olarak anlarlar ve ekiplerini sürekli iyileştirme için koçluk yaparlar.'
  },
  {
    id: 'people_oriented',
...
export const OPEN_QUESTIONS = {
  stopDoing: 'Stop Doing: Liderlerin bugünden itibaren bir şeyler yapmayı bırakacağını bilseydiniz, en çok neyi bırakmalarını isterdiniz?',
  startDoing: 'Start Doing: Liderlerin bugünden itibaren bir şeyler yapmaya başlayacağını bilseydiniz, en çok ne yapmalarını isterdiniz?',
  keepDoing: 'Keep Doing: Liderlerin bugün olduğu gibi bir şeyler yapmaya devam edeceğini bilseydiniz, ne olurdu? (İyi uygulamalar için isim paylaşabilirsiniz)'
};
